...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    if (empty($namaErr) && empty($emailErr) && empty($nimErr) && empty($jurusanErr) && empty($fakultasErr)) {
        $dataMahasiswa = [
            'nama' => $nama,
            'email' => $email,
            'nim' => $nim,
    ...
    <?php if (!empty($dataMahasiswa)): ?>
        <div class="container">
            ...
            <table border="1">
                ...
                <tr>
                    <td><?= htmlspecialchars($dataMahasiswa['nama']) ?></td>
                    <td><?= htmlspecialchars($dataMahasiswa['email']) ?></td>
                    <td><?= htmlspecialchars($dataMahasiswa['nim']) ?></td>
                    <td><?= htmlspecialchars($dataMahasiswa['jurusan']) ?></td>
                    <td><?= htmlspecialchars($dataMahasiswa['fakultas']) ?></td>
                </tr>
        </div>
    </div>
    <?php endif;} ?>
